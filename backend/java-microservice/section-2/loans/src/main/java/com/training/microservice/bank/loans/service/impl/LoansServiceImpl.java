...
import com.training.microservice.bank.loans.exception.ResourceNotFoundException;
import com.training.microservice.bank.loans.mapper.LoansMapper;
...
public class LoansServiceImpl implements ILoansService {
    ...
    public boolean updateLoan(LoansDto loansDto) {
        Loans loans = loansRepository.finByLoanNumber(loansDto.getLoanNumber()).orElseThrow(
